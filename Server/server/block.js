...
class crafting_table extends basic_block{
    constructor(x=undefined,y=undefined){
        ...
        this.name="crafting_table"
        this.display_name="Crafting Table"
        ...
        this.destroy_time=1.5
        if(!is_server){
            this.left_side_image = crafting_table_left_image
            this.top_side_image = crafting_table_top_image




            this.image=crafting_table_image
        }
