...
class inventory_slot{
    ...
    give_count(count,from=undefined){
        ...
        if(from.count>=count){
            ...
            take = from.count
            count = count - from.count
        }
    

        
        let extra=Entity_class.give_item(this,[this],take)
        
        // this.set_count(this.count+take)

        from.set_count(from.count-(take-extra))
...
class Entity_class{
    ...
    static give_item_to_match(item,inventory,count=undefined){
        ...
        for(let i=0;i<inventory.length && count>0;i++){
            ...
            slot_stack_size = get_property(inventory[i],"stack_size")     
